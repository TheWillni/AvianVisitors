(function () {
  ...
  var SKETCH_VERSION = 'au-vic-r1'; // au-vic-r1: swapped in the AU-VIC (Victoria, Australia) illustration
  // set - 398 species, verified + manually reviewed. r12: 84 eastern NA birds (PR #23) refined + re-cut.
  // r11: full library restyle: every species re-rendered (perched + flight) with clean cutouts.
  ...
  var IMG_VERSION = 'au-vic-r1'; // au-vic-r1: swapped in the AU-VIC (Victoria, Australia) illustration set.
  // r12: 84 eastern NA birds (PR #23) refined + re-cut. r11: full library restyle: every species re-rendered
